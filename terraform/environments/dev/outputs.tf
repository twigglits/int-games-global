output "api_url" {
  description = "Public base URL of the development API."
...
output "secret_prefix" {
  description = "Secrets Manager name prefix for this environment. The delivery workflow reads the client secrets from here to run the smoke test."
